  ...
  return (
    <div className="relative w-full h-[600px] overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, rgba(var(--background), 0.9) 33%, rgba(var(--background), 0.1) 100%)",
        }}
      />
        ...
        <div className="w-full max-w-xl">
          ...
          >
            ...
            <p className="text-lg mb-6 text-default-600">
              Movie Monday is a weekly tradition that brings friends together to
              enjoy cinema. Each week, group members take turns selecting films,
              creating a shared experience that builds community and exposes
              everyone to new genres and perspectives.
            </p>

            <p className="text-lg mb-8 text-default-600">
              Our platform makes it easy to organize your Movie Monday group,
              track what you've watched, and discover new films to enjoy
              together.
            </p>
