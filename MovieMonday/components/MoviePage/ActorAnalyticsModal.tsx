...
import { FilmIcon, Trophy } from "lucide-react";
                ...
                {stats.appearances > 0 ? (
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm text-default-500">
                      ...
                      {stats.wins > 0 &&
                        `, ${stats.wins === 1 ? "1 win" : `${stats.wins} wins`}`}
                    </span>
                  </div>
                ) : (
                  <p className="text-sm text-default-500">
                    No Movie Monday appearances yet
                  </p>
                )}
              </div>
            </ModalHeader>
              ...
              {stats.appearances > 0 ? (
                        ...
                        >
                          <a className="block">
                            <Card
                              isPressable
                              className={
                                movie.isWinner ? "border-2 border-warning" : ""
                              }
                            >
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-default-500 mt-2">
                    As you watch more movies, you'll see analytics for this
                    actor here.
                  </p>
                </div>
              )}
