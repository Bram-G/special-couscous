    ...
    <>
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-1/2 lg:w-3/5">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-full bg-gradient-to-r from-black to-transparent" />
        </div>
      ...
      <section className="py-16 bg-content1">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Learn more about how Movie Monday started and why it's the perfect
